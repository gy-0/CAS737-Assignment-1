...
def gen_catmull_rom_points(key_points):
    ...
    extra_key_points = [key_points[0]] + key_points + [key_points[-1]]
    key_number += 2
    ...
    for i in range(0, segment_number):
        #segment keys
        p0=extra_key_points[1 * i]
        p1=extra_key_points[1 * i + 1]
        p2=extra_key_points[1 * i + 2]
        p3=extra_key_points[1 * i + 3]
